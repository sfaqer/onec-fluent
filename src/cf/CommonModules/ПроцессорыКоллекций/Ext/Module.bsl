...
//
// Параметры:
//  ИмяПроцедуры                - Строка - Имя экспортной процедуры которую необходимо вызвать при выполнении оповещения
//  Модуль                      - Модуль - Модуль, в котором располагается процедура
...
//  МодульОбработкиОшибки       - Модуль - Модуль, в котором располагается процедура обработки ошибки
// 
// Возвращаемое значение:
//  Структура - Описание оповещения со свойствами:
//    * ИмяПроцедуры                - Строка
//    * Модуль                      - Модуль
